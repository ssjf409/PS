...
if __name__ == '__main__':
    ...
    bike_num = [0 for i in range(map_size * map_size)]
    ...
    for x in range(720):
        ...
        for i in range(len(bike_num_data)):
            bike_num[i] = bike_num_data[i]['located_bikes_count']
        # print(bike_num)
        # print()
        ...
        for i in range(len(trucks_data)):
            ...
            trucks[i].location = trucks_data[i]['location_id']
                ...
                if cur_bike_num < bike_num_avg:
                    ...
                    for idx, truck in enumerate(trucks):
                        ...
                        if temp_dist < dist:
                            ...
                            index = idx
                    truck.hasJob = True
                    truck.destination = cur
                    truck.isPickupJob = True
            ...
            for j, truck in enumerate(trucks):
                if truck.hasJob:
                    if truck.location == truck.destination:
                        ...
                        y2 = truck.location // map_size
                        x2 = truck.location % map_size
                        if y1 == y2:
                            if x1 - x2 > 0:
                                # 아래 
